<?php
    try{
        $conn = new PDO("mysql:host=localhost;dbname=restaurant", "root", 'root');
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        $sql = "SELECT * FROM plat";
        $stmt = $conn->query($sql);  //Utilisé pour des requêtes simples sans paramètres, est plus direct et rapide, mais moins flexible.
