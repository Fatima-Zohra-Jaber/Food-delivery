...
<main class="d-flex flex-nowrap">
  ...
  <div class="d-flex flex-column flex-shrink-0 p-3 bg-body-tertiary" style="width: 280px;">
    <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto link-body-emphasis text-decoration-none">
      <img src="../images/logo.png" alt="Logo" class="bi pe-none me-2" width="40" height="32">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li class="nav-item">
        ...
        <ul class="collapse list-unstyled" id="submenuPlat">
            <li><a href="plats.php" class="nav-link link-body-emphasis ms-4 active">Tous les plats</a></li>
